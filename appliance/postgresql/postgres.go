...
func (p *Postgres) syncedInst() *discoverd.Instance {
	return p.syncedInstVal.Load().(*discoverd.Instance)
}

func (p *Postgres) setSyncedInst(inst *discoverd.Instance) {
